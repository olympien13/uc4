...
df_data = pd.read_json('ftdata.jsonl', lines=True)
...
for index, row in df_data.iterrows():
    ...
    for i in range(1, 101):
        ...
        output_df_data.loc[current_index_dataframe] = [output_df_data.at[current_index_dataframe, 'input'], output_df_data.at[current_index_dataframe, 'output']]
...
output_df_data.to_json('output.jsonl', orient='records', lines=True)
